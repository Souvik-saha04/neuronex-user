...
const navItems = [
  ...
  { href: '/user/health-records',     icon: '📄', label: 'Health Records' },
  { href: '/user/upload-prescription',icon: '📤', label: 'Upload Prescription' },
  { href: '/user/ai-alerts',          icon: '🧠', label: 'AI Health Alerts' },
  { href: '/user/nearby-help',        icon: '📍', label: 'Nearby Help' },
];
